...
export default function TwoView() {
    return (
       ...
       El mundo digital cambio la forma en que los medios de comunicacion informamos y nos ofreció una visión diferente de como contarles a nuestros seguidores las historias que tanto les interesa. <br /> <br />  La nueva forma como los lectores consumen informacion, nos llevo a explorar y crear este formato que ustedes están a punto de experimentar. <br /> <br />   Estimados amigos, V12 Magazine  se convierte en la primera revista 100% interactiva del sector automotor colombiano. Somos una publicación para leer, ver, oír y hasta tocar, que se puede llevar en sus dispositivos móviles o tener en su computador. Aqui la informacion es de doble vía porque usted amigo lector, vivirá la informacion, la experimentara y estamos seguros de que también la disfrutara. <br /> <br />   Sin mas preámbulos y de la mano del Todopoderoso, con solo seguir las flechas y hacer clic, viva la nueva experiencia que brinda este innovador formato. ¡Gracias! <br /> <br /> RUBEN GONZALEZ <br /> Director-gerente <br /> GAD"
       </AnimatedSlideInLeft>
      </div>
    )
}
